...
const LIVE = new Set([
  /* 🔴 /shop انشالت بالدمج ٣٠ آب · صارت تحويل ٣٠١ على /products، فأي رابط
     داخلي عليها قفزة زيادة. بقاؤها برّا القائمة بيخلي البوابة تمسكها لو رجعت. */
  ...
  /* 🔴 الأربعة القدامى حسب نوع البشرة **انشالوا ٣٠ آب** · وكان مكتوب هون
     «لسا صفحات حية بووردبريس» وهاد **كان غلطاً**. مقيس على الموقع الحي:
       /routines/oily · /routines/dry · /routines/combination  →  404
       /routines/sensitive  →  الصفحة مسوّدة واسمها «(متقاعدة)»
     يعني القائمة كانت بتبارك روابط ميتة بدل ما توقفها · وهاد عكس شغلها.
     ⚠️ وما بقدر أفحص سلوك الزائر غير المسجَّل لأن الموقع خلف قفل
        Coming Soon · فالحكم على المسوّدة من حالتها بووردبريس مش من ردّها. */
