...
add_action( 'woocommerce_before_customer_login_form', function () {
	...
	/* ══════════════════════════════════════════════════════════════════
	   ...
	   **البيتان:** مجزوء الرمل · فاعلاتن فاعلاتن بكل شطر (والخبن زحاف
	   ...
	   🔴 **والمعنى مقصود بدقّة:** «رُبَّ بَحْرٍ لا يُرَوّي» بتفشّخ
	      **الكثير** بدل ما تنفخ **القليل** · يعني بتوصل «منتجات أقل
	      بتكفي» بلا ما توعد بإشي. و«وَبِلاهُ قَدْ نَضِلُّ» الضمير
	...
	echo '<aside class="auth-side" aria-hidden="true">'
		...
		. 'رُبَّ بَحْرٍ لا يُرَوّي · وَقَليلٍ لا يَقِلُّ<br>'
		. 'أَوَّلُ الدَّربِ سُؤالٌ · وَبِلاهُ قَدْ نَضِلُّ'
		. '</blockquote>'
