...
/* ══════════════════════════════════════════════════════════════════════
   🔴 **مطفي بقرار ريّان · ٦ أيلول ٢٠٢٦ · والسبب بنيوي لا ذوقي**
   ══════════════════════════════════════════════════════════════════════
   ريّان: «اقتراح المنتج غلط يطلع بعد ما تتم العملية · الأصحّ إنها تطلع
   بصفحة الدفع نفسها».

   ورجعنا لمبادئ علم النفس التسويقي قبل ما نحكم، وطلع إنه محق **بنموذجنا
   بالذات** (دفع عند الاستلام):

     · **التفكير من الدرجة التانية** · الأثر الأول ربح، والأثر التاني
       **مبلغ أكبر عالباب**. وأغلى فشل عنّا هو الرفض عالباب لأننا بندفع
       المندوب مرّتين · فأي إشي بيرفع رقم الباب بيرفع خطر الرفض.

     · **المحاسبة الذهنية** · هي سكّرت حساب ٦٥٫٩٥ لمّا أكّدت. تحويله
       لـ٧٨٫٥٥ مش «إضافة صنف» · هو **تغيير رقم متّفق عليه بعد الاتفاق**.

     · **قاعدة الذروة والنهاية** · الزبونة بتتذكّر النهاية. لو آخر إشي
       بصفحة التأكيد عرض بيع، الذكرى بتنتهي على «بدهم مصاري أكثر».

     · **المقاومة النفسية** · الضغط فوراً بعد الامتثال هو المشغّل
       الكلاسيكي لردّة الفعل العكسية.

   ⤷ والحجّة المقابلة (الالتزام والاتساق · صفر خطر على البيعة الأصلية)
     **بتفترض قبولاً بلا كلفة** · وبالدفع عند الاستلام الكلفة حقيقية.

   ⚠️ **والكود بيضل كامل ومفحوص** · التشغيل سطر واحد. ولو تحوّل المتجر
      يوماً لدفع بالبطاقة، الحجّة كلها بتسقط والعرض بيرجع منطقياً.

   ⤷ وبديل صفحة التأكيد **مش تفضيتها**: هي «النهاية» وقيمتها عالية،
     فبتخدم بدل ما تبيع (كيف تستعملي اللي طلبتيه · بأي ترتيب · وشو
     الخطوة الجاية) · وهاد وعد صفحة «من نحن» حرفياً.
   ══════════════════════════════════════════════════════════════════════ */
if ( ! defined( 'LUVIT_UP_ON' ) ) {
	define( 'LUVIT_UP_ON', false );
}
